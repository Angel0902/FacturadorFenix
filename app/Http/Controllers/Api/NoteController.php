...
class NoteController extends Controller
{
    ...
    public function send(Request $request)
    {
        ...
        $response['sunatResponse'] = $sunat->sunatResponse($result,$note,$response['xml']);

        $sunat->getHtmlReport($note,$company,$response['hash']);        
        $sunat->generatePdfReport($note,$company,$response['hash']);
