        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">            
                <h1 class="text-3xl font-semibold text-gray-700 mb-3">
                    <span class="text-indigo-500" >Usuarios / </span> Crear
                </h1>
                ...
                <div class="bg-white px-6 py-8 rounded-lg shadow">
                    ...
                    <div class="grid grid-cols-2 gap-6" >
                        <div>
                            <label >
                                Nombre
                                <TextInput v-model="user.name" type="text" class="w-full"/>    
                            </label>  
                        </div>
                        <div>
                            <label >
                                Correo Electronico
                                <TextInput v-model="user.email" type="email" class="w-full"/>    
                            </label>
                        </div>
                        <div>
                            <label >
                                Clave
                                <TextInput v-model="user.password" type="password" class="w-full"/>    
                            </label>
                        </div>
                        <div>
                            <label >
                                Rol
                                <select v-model="user.rol" class="w-full rounded" >
