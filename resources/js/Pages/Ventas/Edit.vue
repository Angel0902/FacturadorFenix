...
export default {
    ...
    mounted(){
        let productos = JSON.parse(this.venta.productos);
        this.form.productos = [];
        
        this.venta.mtoOperGravadas = 0;
        this.venta.valorVenta = 0;
        this.venta.mtoIGV = 0;
        this.venta.totalImpuestos = 0;
        this.venta.subTotal = 0;
        this.venta.mtoImpVenta = 0;
        this.venta.redondeo = 0;
    ...
    methods:{
        envioSunat(){
            ...
            .then((response) => {
                ...
                if(resp.sunatResponse.succes){
                    ...
                    this.$inertia.put(this.route('ventas.update',this.venta),this.form);
                }else{
                    this.venta.CDR = '';
        ...
        update(){
            ...
            if (confirm(text) == true) {
                ...
                //this.$inertia.visit(this.route('ventas.update',this.venta), { method: 'put', data: this.form });
                this.form._method = 'put',
                //console.log(this.organizacion);
                this.$inertia.form(this.form).post(this.route('ventas.update',this.venta));
                //this.$inertia.put(this.route('ventas.update',this.venta),this.form);
                //this.$inertia.form(this.form).put(this.route('ventas.update',this.venta));
            }
